...
module.exports = async function renderCharacter(character, options){
    ...
    doc.text('', options.margin + 10, Math.max(tagHeight, languageHeight) + 10);
    ...
    function renderHeader(){
        doc.strokeColor('#000000')
            .fillColor('#000000');
        const maxNameWidth = doc.page.width - (options.margin*2 + 150 + 5);
        const maxTraitWidth = doc.page.width - (options.margin*2 + 5 + 200);
    ...
    function renderAttributes(row){
        ...
        const attributes = _.keys(character.provides.attributes);
