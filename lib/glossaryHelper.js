...
exports.format = async function(content, anchor, is_gm, allEntries, campaignId){
...
exports.prepEntries = async function(glossary_entries, is_gm, campaignId){
    let entries = [];
    if (is_gm){
...
exports.reviewReady = async function(campaignId){
    const status = await models.glossary_status.findOne({name:'Ready', campaign_id:campaignId});
